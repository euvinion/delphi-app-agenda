...
procedure TFrmNovo.CancelarClick(Sender: TObject);
begin
  Close;
end;
...
begin
  ...
  DM.QryCadastro.SQL.Add('INSERT INTO novos (nome, telefone, email, obs) VALUES (:nome, :telefone, :email, :obs)');
  ...
  DM.QryCadastro.ParamByName('obs').AsString := Memo.Text;
